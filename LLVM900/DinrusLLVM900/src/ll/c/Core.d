...
enum ЛЛЦелПредикат {
  Равно  = 32, /**< равно */
  НеРавно ,      /**< не равно */
  ББольшеЧем ,     /**< бцел больше чем */
  ББольшеРавно ,     /**< бцел больше или равно */
  БМеньшеЧем ,     /**< бцел меньше чем */
  БМеньшеРавно  ,     /**< бцел меньше или равно */
  ЗБольшеЧем ,     /**< значный больше чем */
  ЗБольшеРавно ,     /**< значный больше или равно */
  ЗМеньшеЧем ,     /**< значный меньше чем */
  ЗМеньшеРавно      /**< значный меньше или равно */
} ;

enum ЛЛПредикатРеала {
  Ложь, /**< Всегда нет (always folded) */
  УРавно,            /**< Да, если упорядочено и равно */
  УБольшеЧем,            /**< Да, если упорядочено и больше чем */
  УБольшеРавно,            /**< Да, если упорядочено и больше чем или равно */
  УМеньшеЧем,            /**< Да, если упорядочено и меньше чем */
  УМеньшеРавно,            /**< Да, если упорядочено и меньше чем или равно */
  УНеРавно,            /**< Да, если упорядочено и операнды неравны */
  Упоряд,            /**< Да, если упорядочено (Нет nans) */
  Неупоряд,            /**< Да, если неупорядочено: isnan(X) | isnan(Y) */
  НРавно,            /**< Да, если неупорядочено или равно */
  НБольшеЧем,            /**< Да, если неупорядочено или больше чем */
  НБольшеРавно,            /**< Да, если неупорядочено, больше чем или равно */
  НМеньшеЧем,            /**< Да, если неупорядочено или меньше чем */
  НМеньшеРавно,            /**< Да, если неупорядочено, меньше чем или равно*/
  ННеРавно,            /**< Да, если неупорядочено или не равно */
  Истина   /**< Всегда да (always folded) */
} ;
...
ткст0 ЛЛCоздайCообщение(ткст0 сообщение); //+
