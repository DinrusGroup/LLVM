...
// library. This is intended to be используется by linkers which are к-only in
 ...
 */
  ...
  /// This provides a dummy тип for pointers to the LTO объект.
  alias ук llvm_lto_t;
  ...
  enum llvm_lto_status {
    ...
    //  Added к-specific ошибка codes
    LLVM_LTO_NULL_OBJECT
  } ;
alias llvm_lto_status llvm_lto_status_t;

  /// This provides к interface to иниц link time optimizer. This allows
  /// linker to use dlopen() interface to dynamically load LinkTimeOptimizer.
  /// extern (C)helps, because dlopen() interface uses имя to найди the symbol.
