...
LLEXPORT ЛЛЗначение ЛЛКонстУкНаЭлт(ЛЛЗначение ConstantVal,
...
LLEXPORT LLVMBool ЛЛвПределах_ли(ЛЛЗначение укНаЭлт){
return LLVMIsInBounds(укНаЭлт) ;
}
LLEXPORT void ЛЛУстВПределах(ЛЛЗначение укНаЭлт, LLVMBool InBounds){
 LLVMSetIsInBounds(укНаЭлт, InBounds) ;
}
